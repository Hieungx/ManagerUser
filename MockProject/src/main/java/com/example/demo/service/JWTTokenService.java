...
public class JWTTokenService {
    ...
    public static void addJWTTokenHeader(HttpServletResponse response, String username) {
    ...
    public static Authentication parseTokenInformation(HttpServletResponse request){
